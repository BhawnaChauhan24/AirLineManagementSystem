...
public class BookFlight extends JFrame implements ActionListener{
    ...
    JTextField tfaadhar;
    JLabel tff_name,tfl_name, tfnationality, tfaddress, labelgender, labelfname, labelfcode, labelfamt,lblclass;
    JButton bookflight, fetchButton, flight;
    Choice f_source, f_destination, f_cls;
    JDateChooser dcdate;
    ...
    public BookFlight() {
        ...
        lblclass.setBounds(700, 120, 120, 25);
        lblclass.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblclass);
                
        f_cls = new Choice();
        f_cls.setBounds(860, 120, 120, 25);    
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                String query = "insert into reservation values('PNR-"+random.nextInt(1000000)+"', 'TIC-"+random.nextInt(10000)+"', '"+aadhar+"', '"+f_name+"', '"+l_name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+flightamt+"', '"+src+"', '"+dest+"', 'Seat_No-"+random.nextInt(100)+"','"+date+"','"+f_cls+"')";
