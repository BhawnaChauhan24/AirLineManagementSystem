...
create table reservation (PNR varchar(15), ticket varchar(15), aadhar varchar(15), f_name varchar(30), l_name varchar(30),
nationality varchar(15), flightname varchar(20), flightcode varchar(20), flightamt varchar(10), src varchar (20),
 dest varchar(20), SEAT_No varchar (10), date varchar(15), f_cls text(30));
